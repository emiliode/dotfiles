...
keys = [
    ...
    Key(
        [mod, "shift"],
        "a",
        lazy.spawn("alacritty -e 'nvim /home/emil/.config/qtile'"),
        desc="Config qtile",
    ),
    Key(
        [mod],
    ...
    Key(
        [mod],
        "v",
        lazy.spawn(terminal + " -e nvim /home/michal/sync/wiki/index.wiki"),
    ...
    Key([mod], "F8", lazy.group["scratchpad"].droptown_toggle("term")),
    # Window controls
    Key(
        [mod],
        "j",
...
groups.append(
    ScratchPad(
        "scratchpad", [DropDown("term", "alacritty", height=0.4, width=0.65, x=0.175)]
    )
)
layout_theme = {
    "border_width": 3,
